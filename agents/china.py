...
from models.negotiator import NegotiatorModel, get_china_persona
...
class ChinaNegotiator(BaseNegotiator):
    def __init__(
        ...
        persona = cfg.persona or get_china_persona()
    ...
    def _build_system_prompt(persona: NegotiatorPersona | None = None) -> str:
        p = persona or get_china_persona()
        return (
            f"You are {p.role}. "
    ...
    def _build_system_prompt_static() -> str:
        return ChinaNegotiator._build_system_prompt()
